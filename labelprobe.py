...
def label_probe(directory, blob,
    ...
    if parallel > 1:
        fast_process(fn_t, fn_read, shape, tally_depth, ds, iw, ih,
                categories, fieldmap, thresh, labelcat, batch_size, ahead, verbose,
		parallel)
    else:
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(
        ...
        parser.add_argument(
                '--directory',
                default='~/NetDissect/dissection/caffe_reference_places365',
	...
	for blob in args.blobs:
		...
		label_probe(args.directory, blob, batch_size=args.batch_size,
                    ...
                    tally_depth=args.tally_depth, verbose=True, parallel=0)
		print "ended yay"
    except:
